  ...
  <form method="post" action="vote3.php">
    ...
    <div class="rep-align">
      <div class="hero-body-rep">
        <font color="white">Candidate for 3rd Year Representative</font>
      </div>
      <div class="represent">
        <div class="margin-represent">
          <?php 
          $representative = mysqli_query($conn,"SELECT * FROM candidate WHERE Position='3rd Year Representative' ORDER BY FirstName ASC") or die(mysqli_error());
